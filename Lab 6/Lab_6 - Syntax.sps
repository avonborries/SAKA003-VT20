...
*Check for miltivariate normality with dataset_2 (excluding observations with missing values).
...
*With complete datset.
*First exploratory factor analysis (factors extracted eigenvalue > 1).
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
...
save results /outfile= '/Users/al4605vo/OneDrive - Lund University/06 Courses/05 SGR004F/05 Labs/Lab 6/01 Lab/screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= '/Users/al4605vo/OneDrive - Lund University/06 Courses/05 SGR004F/05 Labs/Lab 6/01 Lab/screedata.sav' .
...
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 ar20 ar21 
    ar22 ar23 ar24 ar25 ar26 ar27 ar28 ar8 ar16
  /MISSING LISTWISE 
...
*3 factors w.o/ 8, 16, 26.
FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar27 ar28
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT liberal
  /METHOD=ENTER research domestication life_support.
